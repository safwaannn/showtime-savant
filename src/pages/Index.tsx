...
const Index = () => {
  ...
  const featuredMovies = [
    ...
    },
    {
      ...
      title: "The Batman",
      poster:
        "https://images.unsplash.com/photo-1609743522653-52354461eb27?w=400&h=600&fit=crop",
      rating: 7.8,
      duration: "2h 56m",
  ...
  const handleBrowseTheaters = () => {
    window.location.href = "/theaters"; // ✅ Direct to theaters page
  };
        ...
        <section className="relative py-20 px-4 bg-gradient-to-b from-cinema-dark to-background">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              ...
              cinema like never before with the best seats, latest movies, and
              seamless booking.
            </p>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                Book tickets for the latest blockbusters and experience them on
                the big screen
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Choose from the best seats with our interactive seat
                    selection and enjoy premium cinema experience.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Book tickets at theaters across the city. Find the most
              ...
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Simple and fast booking process. Select your movie, choose
                    seats, and confirm - it's that easy!
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-primary to-primary-glow">
          <div className="container mx-auto text-center">
            ...
            <p className="text-primary-foreground/90 text-lg mb-8 max-w-2xl mx-auto">
              Don't miss out on the latest releases. Book your tickets now and
